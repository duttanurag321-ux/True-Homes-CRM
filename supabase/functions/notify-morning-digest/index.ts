...
// N follow-ups today" push, counting everything due today regardless
// of whether it also has a specific time set.
...
Deno.serve(async (req) => {
  ...
  const { data: leads } = await supabase
    ...
    .not('call_status', 'is', null) // only counts leads that have actually been called before — matches the app's own "Follow-ups" tab definition
